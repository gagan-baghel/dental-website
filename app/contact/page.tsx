      ...
      <main className="site-main">
        <section className="section-shell section-shell--wide px-4 pt-6 md:px-6 md:pt-10">
          <div className="rounded-[32px] bg-[linear-gradient(135deg,#113247_0%,#2d6a86_60%,#4f95b3_100%)] px-6 py-16 text-white md:px-12 md:py-20">
            <p className="text-xs uppercase tracking-[0.18em] text-[#d7eef6]">Contact Us</p>
          ...
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            <div className="space-y-5">
              <article className="rounded-2xl border border-[#c8dbe7] bg-white/90 p-6">
                <p className="text-xs uppercase tracking-[0.15em] text-[#2f88ab]">Clinic Address</p>
              ...
              <article className="rounded-2xl border border-[#c8dbe7] bg-white/90 p-6">
                <p className="text-xs uppercase tracking-[0.15em] text-[#2f88ab]">Working Hours</p>
              ...
              <article className="rounded-2xl border border-[#c8dbe7] bg-white/90 p-6">
                <p className="text-xs uppercase tracking-[0.15em] text-[#2f88ab]">Map</p>
              ...
              <article className="rounded-2xl bg-[#0f2736] p-6 text-white">
                <p className="text-xs uppercase tracking-[0.15em] text-[#c7e7f2]">Emergency Support</p>
